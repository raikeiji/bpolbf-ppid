...
class Umkm extends Model
{
    ...
    public function get_list(){
      ...
      foreach ($list as $res) {
          ...
          $row[] = $res->koordinat;
          $row[] = $res->created;
          $row[] = "<button class='btn btn-xs btn-info' onclick='edit(".$res->id.")' type='button'>Add Produk</button>
                    <button class='btn btn-xs btn-warning' onclick='edit(".$res->id.")' type='button'>Edit Umkm</button>
                    <button class='btn btn-xs btn-danger' onclick='hapus(".$res->id.")' type='button'>Delete Umkm</button";
